...
class ajaxProcessor
{
	...
	private function setRequestParams() {		
		global $neloCore;
		$this->setMyParamValue($this->actionCode, $neloCore->ClearInput($_POST['actioncode']), 0, true);		
	}//end of function	
	...
	public function getCustomerDetails(){
		...
		$existing_email = $neloCore->ClearInput($_POST['existing_email']);			
		$client_sql=mysql_query("select * from nelo_clienti where email='".$existing_email."' limit 1");
