...
?>    
 ...
 <script type="text/javascript">
	$(document).ready(function(){
      ...
      <hr />
        <form action="istoric_arhive_rezervari.php" method="post" id="form1">
      ...
      <span style="padding-left:0px;"><a id="datepickerImage" href="javascript:;"><img src="../imagini/month.png" height="16px" width="16px" style=" margin-bottom:-4px;" border="0" /></a></span>&nbsp;&nbsp;&nbsp;&nbsp; <strong><?=VB_TO?></strong> &nbsp;&nbsp;&nbsp;&nbsp;<input id="txtToDate" name="toDate" style="width:68px" type="text" readonly="readonly"/>
      <span style="padding-left:0px;"><a id="datepickerImage1" href="javascript:;"><img src="../imagini/month.png" height="18px" width="18px" style=" margin-bottom:-4px;" border="0" /></a></span>&nbsp;&nbsp;&nbsp;&nbsp;<strong><?=VB_BY?></strong>&nbsp;&nbsp;&nbsp;&nbsp;<select name="shortby"><option value="booking_time" selected="selected"><?=VIEW_ACTIVE_BOOKING_DATE?></option><option value="start_date"><?=ROOM_BLOCK_CHECK_IN_DATE?></option><option value="end_date"><?=ROOM_BLOCK_CHECK_OUT_DATE?></option></select></td></tr>
