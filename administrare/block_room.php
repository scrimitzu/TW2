...
if(isset($_POST['block'])){
	...
	$nelobooking->generateBlockingDetails(); 
	...
	$sql = mysql_query("INSERT INTO nelo_rezervari (booking_id, booking_time, start_date, end_date, client_id, is_block, payment_success, block_name) values(".$bookingId.", NOW(), '".$_SESSION['sv_mcheckindate']."', '".$_SESSION['sv_mcheckoutdate']."', '0', 1, 1, '".mysql_real_escape_string($_POST['block_name'])."')");	

	foreach($reservationdata as $revdata){

		foreach($revdata['availablerooms'] as $rooms){				

		$sql = mysql_query("INSERT INTO nelo_rezervari_site (bookings_id, room_id, room_type_id) values(".$bookingId.",  ".$rooms['roomid'].", ".$revdata['roomtypeid'].")");
          ...
          <table cellpadding="0"  cellspacing="7" border="0">
            ...
            <tr>
              ...
              <td><input id="txtFromDate" name="check_in" style="width:68px" type="text" readonly="readonly" AUTOCOMPLETE=OFF />
                ...
                <span style="padding-left:3px;"><a id="datepickerImage" href="javascript:;"><img src="../imagini/month.png" height="16px" width="16px" style=" margin-bottom:-4px;" /></a></span></td>
            ...
            <tr>
              ...
              <td><input id="txtToDate" name="check_out" style="width:68px" type="text" readonly="readonly" AUTOCOMPLETE=OFF />
                ...
                <span style="padding-left:3px;"><a id="datepickerImage1" href="javascript:;"><img src="../imagini/month.png" height="18px" width="18px" style=" margin-bottom:-4px;" /></a></span></td>
