...
if(isset($_POST['act_sbmt'])){
		...
		$neloAdminMain->global_setting_post();

		header("location:setari_globale.php");
...
$global_setting=$neloAdminMain->global_setting();
        ...
        <form action="<?=$_SERVER['PHP_SELF']?>" method="post" id="form1">
          ...
          <table cellpadding="5" cellspacing="2" border="0">
            ...
            <tr>
              ...
              <td valign="middle"><input type="text" name="email_notification" id="email_notification" value="<?=$neloCore->config['conf_notification_email']?>" class="required" style="width:250px;" /></td>
            ...
            <tr>
              ...
              <td><input type="text" name="currency_code" id="currency_code" value="<?=$neloCore->config['conf_currency_code']?>"  class="required" style="width:70px;"  /></td>
             ...
             <tr>
              ...
              <td><input type="text" name="currency_symbol" id="currency_symbol" value="<?=$neloCore->config['conf_currency_symbol']?>"  class="required" style="width:70px;"  /></td>
            ...
            <tr>
              ...
              <td><input type="text" name="tax" id="tax" size="6" class="required number" value="<?=$neloCore->config['conf_tax_amount']?>" />&nbsp;%</td>
            ...
            <tr>
              ...
              <td><?php
                     ...
                     if($neloCore->config['conf_price_with_tax']==1){
