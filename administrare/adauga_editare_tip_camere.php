...
if(isset($_POST['submitRoomtype'])){
	...
	$neloAdminMain->add_edit_roomtype();
	header("location:tip_camere.php");	
	exit;
}
include("header.php"); 
include("../setari/conf.class.php");
...
if(isset($_GET['id']) && $_GET['id'] != ""){
	...
	if($id){
		$result = mysql_query($neloAdminMain->getRoomtypesql($id));
	...
	header("location:admin_capacitate.php");
	exit;
}
?>  
        ...
        <form action="<?=$_SERVER['PHP_SELF']?>" method="post" id="form1" enctype="multipart/form-data">
          <table cellpadding="5" cellspacing="2" border="0">
            ...
            <tr>
              ...
              <td><input type="file" name="img" id="img" /><?php if($row['img'] != ""){ echo '<span style="margin-left:15px"><a href="../galerie/'.$row['img'].'" target="_blank"><strong>View Image</strong></a>&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FF0000"><strong>Delete Image</strong>&nbsp;</font><input type="checkbox" name="delimg"></span>'; }?></td>
            </tr>
            <tr>           
