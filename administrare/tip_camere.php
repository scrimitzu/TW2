...
<div id="container-inside">
 <span style="font-size:16px; font-weight:bold"><?php echo ROOM_TYPE_LIST;?></span>
    <input type="button" value="<?php echo ADD_NEW_ROOMTYPE;?>" onClick="window.location.href='adauga_editare_tip_camere.php?id=0'" style="background: #EFEFEF; float:right"/>
 <hr />
  <table class="display datatable" border="0">
    ...
    <?=$neloAdminMain->generateRoomtypeListHtml()?>
  </table>
</div>
