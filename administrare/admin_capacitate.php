...
<span style="font-size:16px; font-weight:bold"><?php echo CAPACITY_LIST;?></span>
    <input type="button" value="<?php echo ADD_NEW_CAPACITY;?>" onClick="window.location.href='adauga_editare_capacitate.php?id=0'" style="background: #EFEFEF; float:right"/>
 <hr />
  <table class="display datatable" border="0">
    ...
    <?=$neloAdminMain->generateCapacityListHtml()?>
  </table>
</div>
